...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function lockScroll() {
    ...
    // lock page (works better across mobile)
    document.documentElement.style.position = 'fixed';
    document.documentElement.style.top = `-${savedScrollY}px`;
    document.documentElement.style.left = '0';
    document.documentElement.style.right = '0';
    document.documentElement.style.width = '100%';
    // optional class if you want to style when locked
  ...
  // Lock on load so gate "mengunci" scroll sampai tombol diklik
  lockScroll();

  enterBtn.addEventListener('click', () => {
    unlockScroll();
    // scroll halus ke hero
  ...
  // Set target tanggal
  const targetDate = new Date("Oct 29, 2028 08:00:00").getTime();
